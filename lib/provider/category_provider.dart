...
class CategoryProvider extends ChangeNotifier {
  ...
  Future<void> getSubCategoryList(BuildContext context, String categoryID, String languageCode) async {
    _subCategoryList = null;
    ...
    print("WHAT THER FUCK");
    notifyListeners();
  }

  Future<void> getCategoryProductList(BuildContext context, String categoryID, String languageCode) async {
