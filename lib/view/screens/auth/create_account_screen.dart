...
class _CreateAccountScreenState extends State<CreateAccountScreen> {
  ...
  final FocusNode _refByFocus = FocusNode();
  ...
  final TextEditingController _refByController = TextEditingController();
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        getTranslated('fiend_code', context),
                        style: Theme.of(context).textTheme.headline2.copyWith(color: ColorResources.getHintColor(context)),
                      ),
                      SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                      CustomTextField(
                        hintText: "##########",
                        isShowBorder: true,
                        controller: _refByController,
                        focusNode: _refByFocus,
                        inputType: TextInputType.name,
                        capitalization: TextCapitalization.words,
                      ),
                      // SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
                      ...
                      !authProvider.isLoading
                        ...
                        onTap: () {
                          ...
                          String _refBy = _refByController.text.trim();
