          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                ListTile(
                  onTap: () => Navigator.pushNamed(context, Routes.getReferralCodeRoute()),
                  leading: Image.asset(Images.user_ref, width: 20, height: 20, color: Theme.of(context).textTheme.bodyText1.color),
                  title: Text(getTranslated('referral_code', context), style: rubikMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                ),
                ListTile(
                  onTap: () =>  Navigator.pushNamed(context, Routes.getVideoRoute()),
                  leading: Image.asset(Images.profile, width: 20, height: 20, color: Theme.of(context).textTheme.bodyText1.color),
                  title: Text(getTranslated('video', context), style: rubikMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                ),
                ListTile(
