...
import 'package:emarket_user/view/screens/chat/widget/message_bubble.dart';
import 'package:emarket_user/view/screens/chat/widget/message_bubble_shimmer.dart';
...
class ChatScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: ResponsiveHelper.isDesktop(context)? PreferredSize(child: MainAppBar(), preferredSize: Size.fromHeight(80)) :  CustomAppBar(title: getTranslated('message', context)),
